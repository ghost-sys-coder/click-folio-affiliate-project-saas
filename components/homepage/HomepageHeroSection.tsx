        ...
        <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-14 px-6 pb-24 pt-14 lg:grid-cols-2 lg:px-8 lg:pb-32 lg:pt-20">
            <div>
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                    ...
                    <Link
                        href="#features"
                        className="inline-flex items-center justify-center rounded-full border border-white/15 px-6 py-3 text-sm font-semibold text-white/85 transition hover:bg-white/10"
                    >
                        See features
                    </Link>
                </div>
                ...
                <div className="mt-10 grid max-w-xl grid-cols-3 gap-4 border-t border-white/10 pt-8">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-white/55">For every offer</p>
                    </div>
                    <div>
                        <p className="text-2xl font-bold">Live clicks</p>
                        <p className="mt-1 text-sm text-white/55">Tracked daily</p>
                    </div>
                    <div>
                        <p className="text-2xl font-bold">AI posts</p>
                        <p className="mt-1 text-sm text-white/55">For promotion</p>
                    </div>
                </div>
            </div>
            ...
            <div className="relative">
                ...
                <div className="relative rounded-[2rem] border border-white/10 bg-white/10 p-4 shadow-2xl backdrop-blur">
                    <div className="rounded-[1.5rem] bg-[#101022] p-5">
                        ...
                        <div className="mt-4 rounded-2xl border border-white/10 bg-white/0.04 p-5">
                            <div className="mb-4 flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-white/50">Clicks over time</p>
                            ...
                            <div className="flex h-40 items-end gap-2">
                                {[40, 55, 48, 72, 60, 88, 70, 94, 82, 110, 96, 124].map(
                                    (height, index) => (
                                        <div
                                            key={index}
                                            className="flex flex-1 items-end rounded-full bg-violet-500/15"
                                        >
                                            <div
                                                className="w-full rounded-full bg-linear-to-t from-violet-600 to-emerald-300"
                                                style={{ height }}
                                            />
                                        </div>
                                    )
