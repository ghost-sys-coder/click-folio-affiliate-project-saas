...
export async function recordUsageEvent(userId: string, eventType: "content_generation" | "affiliate_link_created" | "affiliate_link_imported" | "campaign_url_generated", metadata?: Record<string, unknown>) {
